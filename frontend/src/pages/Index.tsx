      ...
      >
        {strategy ? (
          ...
          <div className="flex flex-col h-full bg-white relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative" style={{ zIndex: 1 }}>
              <div className="text-center max-w-lg px-6">
                <div className="w-16 h-16 mx-auto mb-6 bg-gray-900 rounded-lg flex items-center justify-center p-2">
                  <img src="/favicon.svg" alt="AgMON Logo" className="w-full h-full object-contain" />
                </div>
